...
$content = '<h3 class="pageName">' . $products->getP_name() . ' </h3>';
$content .= '<div class="row">';

$content .= '<div class="col">
    <div class="card productsIndiv" style="width: 18rem;">
                <div class="productImg"  style="background-image: url(' . $products->getProductUrl() . ')">
                </div>
                <div class="card-body">
                    <h5 class="card-title">' . $products->getP_name() . '</h5>
        ...
        </svg>): ' . number_format($products->getPrice(), 1, ',', ' ')  . '</p>
                        ';
$content .= '
</div>
</div>
